...
class SweDepertment extends Depertment {
    ...
    //get Set 
    setfstreport(reportname:string) {
       this.fstastreport=reportname;
    }
    getfstreport(){
        return this.fstastreport
    }
    ...
    addReport(this:SweDepertment,report: string){
        ...
        this.fstastreport="my first report"
    }
...
//get set 
swe.setfstreport("my 2nd repor")
console.log("fstreport",swe.getfstreport());
